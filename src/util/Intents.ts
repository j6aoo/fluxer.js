...
export type IntentsResolvable = number | bigint | string | IntentsBitField | (number | bigint | string | IntentsBitField)[];

export class IntentsBitField extends BitField<string> {
    ...
    public static override resolve(bit: any): bigint {
